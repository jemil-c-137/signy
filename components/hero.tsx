    ...
    <section>
      <div className="section pt-24 md:pt-28 lg:pt-64 pb-4 bg-cover bg-[70%_100%] bg-[url('../public/hero-image.jpg')]">
        ...
        <div className="flex items-center gap-x-2 mb-3">
          <span className="text-lg font-medium md:text-2xl">1</span>
          <span className="h-[2px] border-r bg-success w-4 block rounded-md"></span>
          <span className="text-sm text-dark-blue-60 md:text-lg">2</span>
          <span className="h-[2px] border-r bg-success w-4 block rounded-md">-</span>
          <span className="text-sm text-dark-blue-60 md:text-lg">3</span>
        </div>
